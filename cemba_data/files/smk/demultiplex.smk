...
rule summary_demultiplex:
    ...
    run:
        ...
        if os.path.exists(os.path.join(local_outdir,"fastq_info.txt")):
            os.remove(os.path.join(local_outdir,"fastq_info.txt"))
        if os.path.exists(os.path.join(local_outdir,"random_index.txt")):
            os.remove(os.path.join(local_outdir,"random_index.txt"))
